...
| [Keş büdcəsi hesablayıcısı](https://camalali.com/alet/kesh) | Keş ölçüsünün hit nisbətinə, orta gecikməyə və mənbə yükünə təsirini hesablayır; bütün açarlar üçün yaddaş ehtiyacı da nəticədədir. | `lib/kesh.ts`, `components/kesh-tool.tsx`, `tests/kesh.mts` | — |
